...
public final class HandCraftedEvaluator implements Evaluator {
    ...
    /**
     * Counting material without this check is wrong in a way that is easy to miss and expensive twice
     * over. {@code 8/8/4k3/8/8/2KB4/8/8} — king and bishop against a bare king, a dead draw — read
     * <strong>+368 centipawns</strong> before it existed: more than a third of a queen for a position no
     * legal sequence can win. Measured at +18.9 ± 13.1 Elo in minor-piece endgames.
     *
     * <p>The second cost is the one that found it. Training labels come from searches performed with
     * this evaluation, so every drawn ending it overvalued taught the network the same error faithfully.
     * The condition itself lives in {@link Material}, because two places need it and a second copy could
     * drift.
     */
    @Override
